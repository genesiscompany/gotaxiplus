...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  const googleMapsKey = process.env.GOOGLE_MAPS_KEY || process.env.EXPO_PUBLIC_GOOGLE_MAPS_KEY || "";
  const env = {
    ...process.env,
    EXPO_PUBLIC_DOMAIN: expoPublicDomain,
    EXPO_PUBLIC_REPL_ID: expoPublicReplId,
    EXPO_PUBLIC_GOOGLE_MAPS_KEY: googleMapsKey,
  };
  ...
  if (googleMapsKey) {
    console.log(`Setting EXPO_PUBLIC_GOOGLE_MAPS_KEY=[configured]`);
  } else {
    console.warn("WARNING: GOOGLE_MAPS_KEY not set — maps will not work in production");
  }
